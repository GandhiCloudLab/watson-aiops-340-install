...
oc create secret generic $PROBE_AUTH_SECRET -n $IRC_NAMESPACE --from-literal=serverBasicAuthenticationUsername=$SEVONE_USER  --from-literal=serverBasicAuthenticationPassword=$SEVONE_PASSWORD
